...
public class GrimTrigger extends Agent {
     ...
     *            the opponent's defect action
     */
    public GrimTrigger(SGDomain domain, SingleAction myCoop,
	    SingleAction myDefect, SingleAction opponentDefect) {
	this.init(domain);
	this.myCoop = myCoop;
	 ...
	 *            the defect action for both players
	 */
	public GrimTriggerAgentFactory(SGDomain domain, SingleAction coop,
		SingleAction defect) {
	    this.domain = domain;
	    this.myCoop = coop;
	    this.myDefect = defect;
	 ...
	 *            the opponent's defect action
	 */
	public GrimTriggerAgentFactory(SGDomain domain, SingleAction myCoop,
		SingleAction myDefect, SingleAction opponentDefect) {
	    this.domain = domain;
	    this.myCoop = myCoop;
	    this.myDefect = myDefect;
