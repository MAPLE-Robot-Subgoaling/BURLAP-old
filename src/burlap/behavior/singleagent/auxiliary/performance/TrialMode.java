 ...
 * {@link PerformanceMetric} will be plotted by {@link PerformancePlotter}. The
 * MOSTRECENTTTRIALONLY mode will result in only the most recent trial's
 * performance being displayed. TRIALAVERAGESONLY will result in only plots for
 * the trial averages to be shown. MOSTRECENTANDAVERAGE will result in both the
 * most recent trial and the trial average plots to be shown.
 * 
