...
public class MacroAction extends Option {
	...
	/**
	 * The list of actions that will be executed in order when this macro-action
	 * is called.
	 */
	protected List<GroundedAction> actionSequence;

	/**
	 * the current execution index of the macro-action sequence. Every time this
	 * action is executed, it will start at index 0.
	 */
	 ...
	 *            the sequence of actions the macro action will execute.
	 */
