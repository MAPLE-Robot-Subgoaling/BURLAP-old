 ...
 * identify them and a set of attributes that define them. Object classes may
 * also be specified as "hidden" which means that they should not be used by the
 * agent planning/learning algorithms when resolving the state. Hidden object
 * classes may be useful for defining POMDP domains or in facilitating the
 * generation of values for observable object classes.
 * 
...
public class ObjectClass {
    ...
    public List<Integer> observableAttributeIndices; // feature vector index of
						     // only attributes that are
						     // observable to the world
    public boolean hidden; // whether this is a hidden object class from the
			   // agent, but defines the state space
     ...
     *            the name identifier for this object class
     * @param hidden
     *            whether this object class is hidden or not
     */
    ...
    /**
     * Returns the number of observable attribtues that define this object
     * class.
     * 
     * @return the number of observable attribtues that define this object
     *         class.
     */
