...
public class GridWorldVisualizer {
	...
	v.addObjectClassPainter(GridWorldDomain.CLASSLOCATION, new CellPainter(
		Color.blue, map));
	v.addObjectClassPainter(GridWorldDomain.CLASSAGENT, new CellPainter(
		Color.red, map));
	...
	public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
	    ...
	    float ry = cHeight - height
		    - ob.getDiscValForAttribute(GridWorldDomain.ATTY) * height;
