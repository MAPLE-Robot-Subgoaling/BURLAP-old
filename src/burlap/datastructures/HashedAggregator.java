 ...
 * If the value has never been queried or added to before, then it assumes an
 * initial value (zero by default). The values are backed by a HashMap.
 * 
 * @author James MacGlashan
 * 
 * @param <K>
 *            the key, which must be hashable.
 */
public class HashedAggregator<K> {
	 ...
	 * 
	 * @param initialValue
	 *            the initial value associated with each key.
	 */
	...
	/**
	 * Adds a specified value to a key. If the key has not been index
	 * previously, its new value is this object's initialValue datamember + v.
	 * 
	 * @param ind
	 *            the key index
	 * @param v
	 *            the value to add to the value associated with ind.
	 */
