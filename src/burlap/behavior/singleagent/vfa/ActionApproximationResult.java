...
/**
 * A class that ties function approximation results to actions. This is useful
...
public class ActionApproximationResult {
	 ...
	 * @param ga
	 *            the grounded action for which the corrsponding approximation
	 *            result should be returned.
	 * @return the corresponding {@link ActionApproximationResult} for the given
	 *         action. Null if there is no corresponding approximation result.
	 */
	public static ActionApproximationResult extractApproximationForAction(
			List<ActionApproximationResult> approximations, GroundedAction ga) {
