...
/**
 * Finds the maximum utilitarian value joint action and retuns a detemrinistic
 * strategy respecting it. The utilitarian value is the sum of the two player's
 * payoffs for a cell. If there are multiple maximums, the first is always used.
 * 
