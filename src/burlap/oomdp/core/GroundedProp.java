...
/**
 * Propositional functions are defined to be evaluated on object parameters and
 * this class provides a definition for a grounded propositional function; that
 * is, it specifies specific object parameters on which the propositional
 * function should be evaluated. The equals method correctly accounts for
...
public class GroundedProp implements Cloneable {
	 ...
	 * 
	 * @param p
	 *            the propositional function that does the evaluation
	 * @param par
	 *            the object name references on which the propositional function
	 *            would be evaluated
	 */
	...
	public boolean equals(Object obj) {
		...
		for (int i = 0; i < params.length; i++) {
			if (!params[i].equals(that.params[i])) {
				// check if there is another parameter with this reference that
				// has the same rename class (which means parameters are order
				// independent)
