 ...
 * {@link burlap.behavior.singleagent.vfa.FeatureDatabase} into a double array.
 * Note that this wrapper is not advised for feature databases like CMACs/Tile
 * coding, since those have very large numbers of sparse features and this
 * wrapper will create entries for all features, including the zero-valued ones.
 * 
...
public class FDFeatureVectorGenerator implements StateToFeatureVectorGenerator {
	 ...
	 * 
	 * @param fd
	 *            the feature database used for generating state features.
	 */
