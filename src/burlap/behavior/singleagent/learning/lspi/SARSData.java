...
/**
 * Class that provides a wrapper for a List holding a bunch of
 * state-action-reward-state ({@link SARS}) tuples. The dataset is backed by an
 * {@link ArrayList}.
 * 
...
public class SARSData {
	...
	/**
	 * Initializes with an empty dataset with initial capacity for the given
	 * parameter available.
	 * 
	 * @param initialCapacity
	 *            the initial capacity of the dataset.
	 */
	 ...
	 * 
	 * @param i
	 *            the index of {@link SARS} tuple to remove.
	 */
