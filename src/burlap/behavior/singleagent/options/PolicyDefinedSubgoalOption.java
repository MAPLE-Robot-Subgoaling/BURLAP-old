...
/**
 * This is a subgoal option whose initiation states are defined by the state in
 * which the policy is defined. If the agent enters a state outside where the
 * policy is defined, that is a termination state with probability 1, as are any
 * subgoal states.
 * 
...
public class PolicyDefinedSubgoalOption extends Option {
	 ...
	 * @param p
	 *            the policy of the option
	 * @param sg
	 *            the subgoals it is meant to reach
	 */
	public PolicyDefinedSubgoalOption(String name, Policy p,
