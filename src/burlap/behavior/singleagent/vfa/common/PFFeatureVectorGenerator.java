...
public class PFFeatureVectorGenerator implements StateToFeatureVectorGenerator {
     ...
     * 
     * @param domain
     *            the domain containing all the propositional functions to use
     */
    public PFFeatureVectorGenerator(Domain domain) {

	this.pfsToUse = new PropositionalFunction[domain.getPropFunctions()
		.size()];
	int i = 0;
     ...
     * 
     * @param pfs
     *            the propositional functions to use.
     */
