...
public class VIModelPlanner implements ModelPlanner {
     ...
     */
    public VIModelPlanner(Domain domain, RewardFunction rf,
     ...
     * states the agent has ever previously obsereved, even though not all may
     * be connected by the current unkown transition model.
     */
	...
	public AbstractGroundedAction getAction(State s) {
		...
		VIModelPlanner.this.observedStates
			.add(VIModelPlanner.this.hashingFactory.hashState(s));
