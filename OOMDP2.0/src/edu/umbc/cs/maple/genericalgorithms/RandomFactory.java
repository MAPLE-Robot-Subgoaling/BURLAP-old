package edu.umbc.cs.maple.genericalgorithms;
...
public class RandomFactory {
	...
	Map <Integer, Random> intMapped_;
	Map <String, Random> stringMapped_;
	...
	public RandomFactory(){
		defaultRandom_ = null;
		intMapped_ = new HashMap<Integer, Random>();
		stringMapped_ = new HashMap<String, Random>();
	}
