...
/**
 * A special non-domain action that causes a visual explorer to rest the state
 * to a specified base state or to a state drawn from a state generator.
 * 
...
public class StateResetSpecialAction implements SpecialExplorerAction {
     ...
     * 
     * @param s
     *            the state to reset to when this action is executed
     */
     ...
     *            the state generate to draw from.
     */
     ...
     * 
     * @param stateGenerator
     *            the state generator to draw from on reset
     */
