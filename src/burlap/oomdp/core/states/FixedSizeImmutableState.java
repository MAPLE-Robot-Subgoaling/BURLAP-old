...
/**
 * The FixedSizeImmutableState is an ImmutableState class that will only allow
 * you to set attribute values of specific objects, and assumes that objects
 * themselves remain in the state. Objects cannot be added to, nor removed from
 * the state.By including this assumption, the order of the objects is not
 * changed internally, and so hashing and equality comparisons are significantly
 * sped up.
 * 
 * @author Stephen Brawner, James MacGlashan
 * 
 */
public final class FixedSizeImmutableState extends OOMDPState implements
