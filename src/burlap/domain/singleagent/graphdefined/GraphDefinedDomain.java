...
public class GraphDefinedDomain implements DomainGenerator {
	...
	for (int i = 0; i < this.numNodes; i++) {
	    this.transitionDynamics.put(i,
		    new HashMap<Integer, Set<NodeTransitionProbibility>>());
	}
	...
	Map<Integer, Set<NodeTransitionProbibility>> actionMap = this.transitionDynamics
		.get(srcNode);
	...
	ObjectInstance o = new ObjectInstance(d.getObjectClass(CLASSAGENT),
		CLASSAGENT);
