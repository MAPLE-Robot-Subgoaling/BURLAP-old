...
public class TitForTat extends Agent {
     ...
     *            the opponent's defect action
     */
    public TitForTat(SGDomain domain, SingleAction myCoop,
	    SingleAction myDefect, SingleAction opponentCoop,
	 ...
	 *            the defect action for both players
	 */
	public TitForTatAgentFactory(SGDomain domain, SingleAction coop,
		SingleAction defect) {
	    this.domain = domain;
	    this.myCoop = coop;
	    this.myDefect = defect;
	 ...
	 *            the opponent's defect action
	 */
	public TitForTatAgentFactory(SGDomain domain, SingleAction myCoop,
		SingleAction myDefect, SingleAction opponentCoop,
		SingleAction opponentDefect) {
	    this.domain = domain;
	    this.myCoop = myCoop;
