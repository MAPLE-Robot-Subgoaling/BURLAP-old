...
/**
 * A class for defining POMDP domains. Primarily, this adds to the
 * {@link burlap.oomdp.singleagent.SADomain} definition an
 * {@link burlap.oomdp.singleagent.pomdp.ObservationFunction}. It also adds an
 * optional {@link burlap.behavior.singleagent.auxiliary.StateEnumerator} since
 * many POMDP algorithms require knowing in advance the full underlying MDP
 * state space. However, not all domains can enumerate all the states, and
 * therefore this field is not required to be set. If a POMDP algorithm requires
 * a {@link burlap.behavior.singleagent.auxiliary.StateEnumerator}, then it
 * should first check the {@link #providesStateEnumerator()} method first.
 * Querying the {@link #getStateEnumerator()} when it is unset will result in a
 * Runtime exception.
 */
public class PODomain extends SADomain {
	 ...
	 * used by this domain.
	 * 
	 * @return the {@link burlap.oomdp.singleagent.pomdp.ObservationFunction}
	 *         used by this domain.
	 */
	 ...
	 * {@link burlap.behavior.singleagent.auxiliary.StateEnumerator} defined for
	 * it. If true, then it does provide a
	 * {@link burlap.behavior.singleagent.auxiliary.StateEnumerator}, if false,
	 * then it does not. POMDP algorithms that require access to a
	 * {@link burlap.behavior.singleagent.auxiliary.StateEnumerator} should
	 * always query this method to check, because querying the
	 * {@link #getStateEnumerator()} when one is not provided by this domain
	 * will result in a runtime exception.
	 * 
	 * @return True if this POMDP domain provides a
	...
	/**
	 * Sets the {@link burlap.behavior.singleagent.auxiliary.StateEnumerator}
	 * used by this domain to enumerate all underlying MDP states.
	 * 
