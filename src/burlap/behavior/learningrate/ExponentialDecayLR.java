 ...
 * independently decayed for each state-action pair (or state feature-action
 * pair). However, the state-action decay will ignore any parameterizations of
 * actions.
 * 
...
public class ExponentialDecayLR implements LearningRate {
	 ...
	 */
	public ExponentialDecayLR(double initialLearningRate, double decayRate,
			double minimumLearningRate, HashableStateFactory hashingFactory,
