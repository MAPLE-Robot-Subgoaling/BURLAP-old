...
public class DynamicWeightedAStar extends AStar {
    ...
    /**
     * This method is being overridden because to avoid reopening closed states
     * that are not actually better due to the dynamic h weight, the reopen
     * check needs to be based on the g score, note the f score
     */
    @Override
