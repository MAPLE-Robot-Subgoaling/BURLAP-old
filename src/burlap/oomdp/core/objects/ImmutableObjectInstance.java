...
public final class ImmutableObjectInstance extends OOMDPObjectInstance
	...
	/**
	 * Creates a new object instance that is a shallow copy of the specified
	 * object instance's values. The object class and name is a shallow copy.
	 * 
	 * @param o
	 ...
	 * a runtime exception if the object instance includes attributes that are
	...
	public String getObjectDescriptionWithNullForUnsetAttributes() {
		...
		for (Value v : values) {
			if (v.valueHasBeenSet()) {
				builder = builder.append("\t").append(v.attName())
						.append(":\t");
