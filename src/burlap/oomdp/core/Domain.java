...
/**
 * This is the base class for an OO-MDP/OO-SG domain. It includes data members
 * for the set of attributes, object classes and propositional functions of the
 * domain.
 * 
...
public abstract class Domain {
    ...
    /**
     * Add a stochastic game action that defines this domain that can be
     * executed by an agent in the game. The set of single agent actions defines
     ...
     * instance of the stochastic game domain (SGDomain). The action will not be
     * added if this domain already has a instance with the same name.
     * 
     * @param sa
     *            the stochastic game action that can be executed by an agent in
     *            the game.
     */
