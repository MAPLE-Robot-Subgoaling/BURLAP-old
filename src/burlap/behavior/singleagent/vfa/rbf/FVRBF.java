...
/**
 * A class for defining radial basis functions for states represented with a
 * double array.
 * 
...
public abstract class FVRBF {
	 ...
	 *            the center state of the RBF unit.
	 * @param metric
	 *            the distance metric to compare query input states to the
	 *            centeredState
	 */
	 ...
	 * @return the double response value of this RBF unit to the query input
	 *         state.
	 */
