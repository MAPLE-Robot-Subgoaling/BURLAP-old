...
public class ConstantWorldGenerator implements WorldGenerator {
    ...
    protected void CWGInit(SGDomain domain, JointActionModel jam,
	    JointReward jr, TerminalFunction tf, SGStateGenerator sg,
	    StateAbstraction abstractionForAgents) {
	this.domain = domain;
	this.worldModel = jam;
	...
	return new World(domain, worldModel, jointRewardModel, tf,
		initialStateGenerator, abstractionForAgents);
    }
