 ...
 * implementation is paramerterized to OO-MDP
 * {@link burlap.oomdp.core.objects.ObjectInstance} references, you can subclass
 * this {@link burlap.oomdp.stochasticgames.agentactions.SGAgentAction} subclass
 * to easily provide that functionality. The
 * {@link burlap.oomdp.stochasticgames.agentactions.GroundedSGAgentAction}
 * instance associated with this action is
 ...
 * {@link #ObParamSGAgentAction(burlap.oomdp.stochasticgames.SGDomain, String, String[])}
 * constructor specifies the valid type of {@link burlap.oomdp.core.ObjectClass}
 * to which the parameters must belong. <br/>
 * <br/>
 * It may also be the case that the order of parameters for an
 * {@link burlap.oomdp.singleagent.ObjectParameterizedAction} is unimportant. In
 * this case, you can specify parameter order groups to indicate for which
 * parameters the order is unimportant. See the
 * {@link burlap.oomdp.singleagent.ObjectParameterizedAction} class
 * documentation for more information of parameter order groups.
 * 
...
public abstract class ObParamSGAgentAction extends SGAgentAction {
	 ...
	 */
	public ObParamSGAgentAction(SGDomain d, String name, String[] types,
	...
	public List<GroundedSGAgentAction> getAllApplicableGroundedActions(State s,
		...
		if (this.parameterTypes.length == 0) {
			GroundedSGAgentAction gsa = new SimpleGroundedSGAgentAction(
					actingAgent, this);
		...
		for (List<String> params : bindings) {
			...
			GroundedObParamSGAgentAction gsa = new GroundedObParamSGAgentAction(
					actingAgent, this, aparams);
			if (this.applicableInState(s, gsa)) {
				res.add(gsa);
			}
		}
