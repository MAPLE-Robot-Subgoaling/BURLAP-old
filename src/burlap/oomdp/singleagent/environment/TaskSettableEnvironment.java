...
/**
 * And {@link burlap.oomdp.singleagent.environment.Environment} interface
 * extension that allows the {@link burlap.oomdp.singleagent.RewardFunction} and
 * {@link burlap.oomdp.core.TerminalFunction} to set and accessed.
 * 
...
public interface TaskSettableEnvironment extends Environment {
	 ...
	 * 
	 * @param rf
	 *            the new {@link burlap.oomdp.singleagent.RewardFunction} of the
	 *            {@link burlap.oomdp.singleagent.environment.Environment}.
	 */
	void setRf(RewardFunction rf);

	/**
	 * Sets the {@link burlap.oomdp.core.TerminalFunction} of this
	 * {@link burlap.oomdp.singleagent.environment.Environment} to the specified
	 * terminal function.
	 * 
	 * @param tf
	 *            the new {@link burlap.oomdp.core.TerminalFunction} of the
	 *            {@link burlap.oomdp.singleagent.environment.Environment}.
	 */
