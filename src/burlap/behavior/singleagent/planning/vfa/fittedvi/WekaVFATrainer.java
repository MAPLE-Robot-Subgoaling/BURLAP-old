 ...
 * for fitted value iteration. This class takes a generator for Weka
 * {@link weka.classifiers.Classifier} objects (specified with the
 * {@link burlap.behavior.singleagent.planning.vfa.fittedvi.WekaVFATrainer.WekaClassifierGenerator}
 * interface and a
 * {@link burlap.behavior.singleagent.vfa.StateToFeatureVectorGenerator} to turn
 * BURLAP {@link burlap.oomdp.core.states.State} objects into feature vectors
 * usable by Weka.
 * 
 * <br/>
 * <br/>
 * This class also provides the static method
 * {@link #getKNNTrainer(burlap.behavior.singleagent.vfa.StateToFeatureVectorGenerator, int)}
 * for construction of the Weka instance-based regression algorithm
 * {@link weka.classifiers.lazy.IBk}, since instance-based methods have
 * convergence guarantees for fitted value iteration.
 * 
...
public class WekaVFATrainer implements SupervisedVFA {
	...
	public static class WekaVFA implements ValueFunction {
		 ...
		 * used to convert BURLAP {@link burlap.oomdp.core.states.State} objects
		 * to feature vectors.
		 */
		protected StateToFeatureVectorGenerator fvGen;

		/**
		 * The Weka {@link weka.classifiers.Classifier} used to predict state
		 * values.
		 */
		 ...
		 *            The
		 *            {@link burlap.behavior.singleagent.vfa.StateToFeatureVectorGenerator}
		 *            used to convert BURLAP
		 *            {@link burlap.oomdp.core.states.State} objects to feature
		 *            vectors.
		 * @param classifier
		 *            The Weka {@link weka.classifiers.Classifier} used to
		 *            predict state values.
		 */
		public WekaVFA(StateToFeatureVectorGenerator fvGen,
		...
		public double value(State s) {
			...
			try {
				...
				throw new RuntimeException(
						"WekaVFA could not produce prediction for instance. Returned message:\n"
								+ e.getMessage());
			}
			return prediction;
		}
