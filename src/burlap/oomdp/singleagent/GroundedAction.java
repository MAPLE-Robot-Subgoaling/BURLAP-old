...
/**
 * A grounded action contains a reference to an action and the names of object
 * instances that are bound to the Action's parameters.
 * 
 * @author James
 * 
 */
public class GroundedAction extends AbstractGroundedAction {
    ...
    /**
     * Initializes the GroundedAction with the given Action reference and action
     * parameters.
     * 
     * @param a
     *            the action reference
     * @param p
     *            a String array of object parameters for the action
     */
     ...
     *            the action reference
     * @param p
     *            a comma delineated String representing the object parameters
     *            for the action.
     */
    public GroundedAction(Action a, String p) {
