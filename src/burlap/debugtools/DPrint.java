...
/**
 * A class for managing debug print statements. Different debug print statements
 * can be associated with different debug ids and enabling or disabling print
 * commands for that debug id can be performed from any class
 * 
...
public class DPrint {
	...
	/**
	 * Boolean which indicates that previously unset debug codes will by default
	 * be allowed to print Setting this value to false will cause all otherwise
	 * unspecified debug values to not print
	 */
	...
	/**
	 * A printf command for the given debug code. If that debug code is set to
	 * false, then the print will not occur.
	 * 
	 * @param c
	 *            the debug code under which printing should be performed
	 ...
	 * @param c
	 *            the code to query.
	 * @return true if printing to that debug code is allowed; false if it is
	 *         not allowed.
	 */
