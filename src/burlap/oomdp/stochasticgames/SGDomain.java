 ...
 * parent {@link burlap.oomdp.core.Domain} class by including an index for
 * possible actions each individual agent can take.
 * 
...
public class SGDomain extends Domain {
    ...
    protected Set<SingleAction> singleActions; // actions that each individual
					       // agent can take
