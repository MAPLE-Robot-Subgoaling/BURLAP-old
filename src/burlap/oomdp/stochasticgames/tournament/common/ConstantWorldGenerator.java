...
/**
 * A WorldGenerator that always generators the same WorldConfiguraiton. It takes
 * the same parameters as a {@link burlap.oomdp.stochasticgames.World}
 * constructor and simply passes them to the World Constructor when a new World
...
public class ConstantWorldGenerator implements WorldGenerator {
	 ...
	 * use the constructor
	 * {@link #ConstantWorldGenerator(burlap.oomdp.stochasticgames.SGDomain, burlap.oomdp.stochasticgames.JointReward, burlap.oomdp.core.TerminalFunction, burlap.oomdp.stochasticgames.SGStateGenerator)}
	 * 
	 * @param domain
	 *            the SGDomain the world will use
	 * @param jam
	 *            the joint action model that specifies the transition dynamics
	 * @param jr
	 ...
	 */
	@Deprecated
	public ConstantWorldGenerator(SGDomain domain, JointActionModel jam,
	 ...
	 * with them, making the constructor parameter for it unnecessary. Instead
	 * use the constructor
	 * {@link #ConstantWorldGenerator(burlap.oomdp.stochasticgames.SGDomain, burlap.oomdp.stochasticgames.JointReward, burlap.oomdp.core.TerminalFunction, burlap.oomdp.stochasticgames.SGStateGenerator, burlap.oomdp.auxiliary.StateAbstraction)}
	 * 
	 * @param domain
	 *            the SGDomain the world will use
	 * @param jam
	...
	protected void CWGInit(SGDomain domain, JointReward jr,
			TerminalFunction tf, SGStateGenerator sg,
			StateAbstraction abstractionForAgents) {
		this.domain = domain;
	...
	public World generateWorld() {
		return new World(domain, jointRewardModel, tf, initialStateGenerator,
