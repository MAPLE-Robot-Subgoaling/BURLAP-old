...
public interface RewardFunction {
    ...
    /**
     * Returns the reward received when action a is executed in state s and the
     * agent transitions to state sprime.
     * 
     * @param s
     ...
     * @return the reward received when action a is executed in state s and the
     *         agent transitions to state sprime.
     */
