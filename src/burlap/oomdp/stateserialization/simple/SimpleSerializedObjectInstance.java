 ...
 * {@link burlap.oomdp.core.objects.ObjectInstance} objects. Deserialization
 * produces {@link burlap.oomdp.core.objects.MutableObjectInstance} objects.
 * 
...
public class SimpleSerializedObjectInstance implements Serializable {
	...
	/**
	 * Initializes by representing the input
	 * {@link burlap.oomdp.core.objects.ObjectInstance}.
	 * 
	 * @param o
	 *            the {@link burlap.oomdp.core.objects.ObjectInstance} to
	 *            represent.
	 */
	...
	/**
	 * Turns this representation into an actual
	 * {@link burlap.oomdp.core.objects.ObjectInstance} whose class and
	 * attributes are associated with the input {@link burlap.oomdp.core.Domain}
	 * 
	 * @param domain
	 *            the {@link burlap.oomdp.core.Domain} to which the returned
	 *            {@link burlap.oomdp.core.objects.ObjectInstance}
	 *            {@link burlap.oomdp.core.ObjectClass} and
	 *            {@link burlap.oomdp.core.Attribute} refers.
	 * @return a {@link burlap.oomdp.core.objects.MutableObjectInstance}
	 */
	public ObjectInstance deserialize(Domain domain) {
		MutableObjectInstance o = new MutableObjectInstance(
				domain.getObjectClass(this.object_class), this.name);
