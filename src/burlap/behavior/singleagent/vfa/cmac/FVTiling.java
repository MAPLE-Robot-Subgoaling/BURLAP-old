...
/**
 * This class provides a tiling of a provided feature vector. Unlike the
 * {@link Tiling} class, this tiling method does not take OO-MDP states as
 * input; instead states must first be converted into a feature vector and
 * passed to this class. As a consequence, this tiling method is object
 * identiferi *dependent*.
 * 
...
public class FVTiling {
	...
	/**
	 * Constructs a tiling using the given widths, offset of each dimension's
	 * tiling, and assuming the tiling is over all dimensions.
	 * 
	 * @param widths
	 *            the widths of each dimension's tiling
	 * @param offset
	 *            the offset of the tiling for each dimension (should be a
	 *            faction of the width).
	 */
	...
	/**
	 * Constructs a tiling using the given widths, offset of each dimension's
	 * tiling, and which dimensions are actually used in the tiling.
	 * 
	 * @param widths
	 *            the widths of each dimension's tiling
	 * @param offset
	 ...
	 *            faction of the width).
	 * @param dimensionMask
	 *            specifies which dimensions are used in the tiling
	 */
	...
	/**
	 * Retunrs a tile for the given input vector. The input must be the same
	 * dimensionality as the specifications for this tiling.
	 * 
	 * @param input
	...
	public FVTile getFVTile(double[] input) {
		...
		if (input.length != this.widths.length) {
			throw new RuntimeException(
					"Error: the input feature vector to be tiled is a different dimensionality "
