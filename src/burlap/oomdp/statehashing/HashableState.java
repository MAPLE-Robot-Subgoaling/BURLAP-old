...
/**
 * This class provides a hash value for {@link burlap.oomdp.core.states.State}
 * objects. This is useful for tabular planning and learning algorithms that
 * make use of hash-backed sets or maps for fast retrieval. You can access the
 * state it hashes from the public data member {@link #s}. If the
 * {@link burlap.oomdp.core.states.State} delegate {@link #s} is a
 * {@link burlap.oomdp.statehashing.HashableState} itself, and you wish to get
 * the underlying {@link burlap.oomdp.core.states.State}, then you should use
 * the {@link #getSourceState()} method, which will recursively descend and
 * return the base source {@link burlap.oomdp.core.states.State}. <br/>
 * <br/>
 * Implementing this class requires implementing the {@link #hashCode()} and
 * {@link #equals(Object)} method. <br/>
 * <br/>
 * Note that this class implements the {@link burlap.oomdp.core.states.State}
 * interface; however, because the purpose of this class is to used with hashed
 * data structures, it is not recommended that you modify the state.
 * 
...
public abstract class HashableState implements State {
	...
	/**
	 * A hash code cached abstract implementation of {@link HashableState}. Once
	 * a hash code is computed, it is saved so that it does not need to be used
	 * again. Implementing this class only requires implementing
	...
	/**
	 * The source {@link burlap.oomdp.core.states.State} to be hashed and
	 * evaluated by the {@link #hashCode()} and {@link #equals(Object)} method.
	 */
	public State s;
	...
	public List<List<String>> getPossibleBindingsGivenParamOrderGroups(
		...
		return s.getPossibleBindingsGivenParamOrderGroups(paramClasses,
				paramOrderGroups);
	}

	/**
	 * Returns the underlying source state is hashed. If the delegate
	 * {@link burlap.oomdp.core.states.State} of this
	 * {@link burlap.oomdp.statehashing.HashableState} is also a
	 * {@link burlap.oomdp.statehashing.HashableState}, then it recursively
	 * returns its {@link #getSourceState()}.
	 * 
	 * @return The underlying source {@link burlap.oomdp.core.states.State} that
	 *         this object hashes and evaluates.
	 */
