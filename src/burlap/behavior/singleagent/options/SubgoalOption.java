...
public class SubgoalOption extends Option {
    ...
    public SubgoalOption(String name, Policy p, StateConditionTest init,
    ...
    public SubgoalOption(String name, StateConditionTestIterable init,
	    StateConditionTest sg, OOMDPPlanner planner, PlannerDerivedPolicy p) {
    ...
    public SubgoalOption(String name, StateConditionTest init,
	    StateConditionTest sg, List<State> seedStatesForPlanning,
	...
	return (initiationTest instanceof StateConditionTestIterable)
		&& (subgoalTest instanceof StateConditionTestIterable);
    }
