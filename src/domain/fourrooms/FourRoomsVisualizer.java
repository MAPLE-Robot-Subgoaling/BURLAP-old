...
public class FourRoomsVisualizer {
	...
	v.addObjectClassPainter(FourRoomsDomain.CLASSGOAL, new CellPainter(d,
		Color.green));
	v.addObjectClassPainter(FourRoomsDomain.CLASSAGENT, new CellPainter(d,
		Color.red));
	...
	public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
	    ...
	    float ry = cHeight - height
		    - ob.getDiscValForAttribute(FourRoomsDomain.ATTY) * height;
