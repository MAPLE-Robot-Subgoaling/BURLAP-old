...
public class RandomStartStateGenerator implements StateGenerator {
	 ...
	 * Reachable states found using a
	 * {@link burlap.oomdp.statehashing.SimpleHashableStateFactory} with
	 * identifier dependence.
	 * 
	 * @param domain
	 *            the domain from which states will be drawn.
	 * @param seedState
	 *            the seed state from which the reachable states will be found.
	 */
	public RandomStartStateGenerator(SADomain domain, State seedState) {
		...
		this.reachableStates = StateReachability.getReachableStates(seedState,
				domain, hashFactory);
	 ...
	 *            the seed state from which the reachable states will be found.
	 * @param hashFactory
	 *            the hash factory to use for the reachability analysis.
	 */
	public RandomStartStateGenerator(SADomain domain, State seedState,
	...
	public State generateState() {
		return this.reachableStates.get(this.random
				.nextInt(this.reachableStates.size()));
	}
