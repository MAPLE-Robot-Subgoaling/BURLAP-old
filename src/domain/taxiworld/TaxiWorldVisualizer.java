...
public class TaxiWorldVisualizer {
	...
	v.addObjectClassPainter(TaxiWorldDomain.CLASSPASS, new CellPainter(d,
		Color.red));
	v.addObjectClassPainter(TaxiWorldDomain.CLASSAGENT, new CellPainter(d,
		Color.yellow));
	...
	public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
	    ...
	    float ry = cHeight - height
		    - ob.getDiscValForAttribute(TaxiWorldDomain.ATTY) * height;
