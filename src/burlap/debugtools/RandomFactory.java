 ...
 * This is useful for if you have many classes that use stochastic processes but
 * you want to have a fixed sequence across process execution for debug
 * purposes. To synchronize, just seed either a mapped random generator or the
 * default in the main method and use the get method to retrieve the random
 * object for all other classes. To break the fixed sequence, just construct it
 * without a seed
 * 
 * 
...
public class RandomFactory {
	...
	public static void main(String[] args) {
		...
		// seed in main method of program to synchronize classes (comment out to
