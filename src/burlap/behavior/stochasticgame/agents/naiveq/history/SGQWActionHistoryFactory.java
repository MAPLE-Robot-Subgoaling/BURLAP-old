...
public class SGQWActionHistoryFactory implements AgentFactory {
    ...
    public SGQWActionHistoryFactory(SGDomain d, double discount,
	    double learningRate, StateHashFactory stateHash, int historySize,
	    int maxPlayers, ActionIdMap actionMap) {
	this.domain = d;
	...
	return new SGQWActionHistory(domain, discount, learningRate, stateHash,
		historySize, maxPlayers, actionMap);
    }
