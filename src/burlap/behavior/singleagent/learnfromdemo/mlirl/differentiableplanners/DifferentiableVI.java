 ...
 * . This class behaves the same as the normal
...
public class DifferentiableVI extends DifferentiableDP implements Planner {
	 ...
	 * @param rf
	 *            the differentiable reward function that will be used
	 * @param tf
	 *            the terminal state function
	 * @param gamma
	 *            the discount factor
	 * @param boltzBeta
	 *            the scaling factor in the boltzmann distribution used for the
	 *            state value function. The larger the value, the more
	 *            deterministic.
	 ...
	 *            terminate.
	 */
	public DifferentiableVI(Domain domain, DifferentiableRF rf,
			TerminalFunction tf, double gamma, double boltzBeta,
