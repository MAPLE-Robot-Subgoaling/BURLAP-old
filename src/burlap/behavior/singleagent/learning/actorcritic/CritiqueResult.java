...
/**
 * The CritiqueResult class stores the relevant information regarding a critique
 * of behavior. Specifically, it contains the value of the critique, the and the
 * state-action-state tuple that is being critiqued.
 * 
...
public class CritiqueResult {
	...
	/**
	 * The state to which the agent transitioned for when it took action a in
	 * state s.
	 */
	...
	/**
	 * Initializes with a state-action-state behavior tuple and the value of the
	 * critique for this behavior.
	 * 
	 * @param s
	 *            a source state
	 * @param a
	 *            the action taken in state s
	 * @param sprime
	 *            the state to which the agent transitioned for when it took
	 *            action a in state s
	 * @param critique
	 *            the critique of this behavior.
	 */
	public CritiqueResult(State s, GroundedAction a, State sprime,
			double critique) {
		this.s = s;
		this.a = a;
		this.sprime = sprime;
