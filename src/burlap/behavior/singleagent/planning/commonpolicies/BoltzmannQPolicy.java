...
public class BoltzmannQPolicy extends Policy implements PlannerDerivedPolicy {
     ...
     * The temperature value controls how greedy the Boltzmann distribution is.
     * The temperature should be positive with values near zero causing the
     * distribution to be more greedy. A high temperature causes the
     * distribution to be more uniform.
     * 
     * @param planner
     *            the q-computable planner to use.
     * @param temperature
     *            the positive temperature value to use
     */
    ...
    private List<ActionProb> getActionDistributionForQValues(
	    List<QValue> qValues) {
