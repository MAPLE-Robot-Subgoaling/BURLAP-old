...
/**
 * A reward function implementation designed around goal conditions that are
 * specified by a
 * {@link burlap.oomdp.auxiliary.stateconditiontest.StateConditionTest} object
 * or a {@link burlap.oomdp.core.TerminalFunction}. When the agent transition to
 * a state marked as a goal state, it returns a goal reward. Otherwise a default
 * reward is returned.
 * 
...
public class GoalBasedRF implements RewardFunction {
	...
	/**
	 * Initializes with transitions to goal states returning a reward of 1 and
	 * all others returning 0
	 * 
	 * @param gc
	 *            {@link burlap.oomdp.auxiliary.stateconditiontest.StateConditionTest}
	 *            object that specifies goal states.
	 */
	...
	/**
	 * Initializes with transitions to goal states returning the given reward
	 * and all others returning 0.
	 * 
	 * @param gc
	 *            {@link burlap.oomdp.auxiliary.stateconditiontest.StateConditionTest}
	 *            object that specifies goal states.
	 * @param goalReward
	 *            the reward returned for transitions to goal states.
	 */
	 ...
	 *            the reward returned for transitions to goal states.
	 * @param defaultReward
	 *            the default reward returned for all non-goal state
	 *            transitions.
	 */
	public GoalBasedRF(StateConditionTest gc, double goalReward,
	 ...
	 * function, returning a reward of 1 and all others returning 0
	 * 
	 * @param tf
	 *            {@link TerminalFunction} object that specifies goal states.
	 */
	...
	/**
	 * Initializes with transitions to goal states, indicated by the terminal
	 * function, returning the given reward and all others returning 0.
	 * 
	 * @param tf
	 *            {@link TerminalFunction} object that specifies goal states.
	 * @param goalReward
