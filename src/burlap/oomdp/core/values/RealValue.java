...
public class RealValue extends Value {
	...
	throw new UnsupportedOperationException(new Error(
		"Value is real, cannot add relational target"));
    }

    @Override
    public int getDiscVal() {
	throw new UnsupportedOperationException(new Error(
		"Value is real, cannot return discrete value"));
    }
	...
	throw new UnsupportedOperationException(new Error(
		"Value is real, cannot clear relational targets"));
    }

    @Override
    public void removeRelationalTarget(String target) {
	throw new UnsupportedOperationException(new Error(
		"Value is real, cannot modify relational targets"));
    }
	...
	throw new UnsupportedOperationException(new Error(
		"Value is real, cannot return relational values"));
    }
