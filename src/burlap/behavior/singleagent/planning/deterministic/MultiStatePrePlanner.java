...
/**
 * This is a helper class that is used to run a valueFunction from multiple
 * initial states to ensure that an adequate plan/policy exists for each them.
 * It makes uses of an iterable state condition test to define the states from
 * which planning should performed or a collection of state objects.
 * 
