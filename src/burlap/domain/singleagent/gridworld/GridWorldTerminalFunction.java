 ...
 * based on the location of the agent in the world. An alternative approch would
 * be to use location objects and the atLocation propositional function to
 * specify terminal states, but this approach may be simpler to define or when
 * terminal states are defined independent of location objects.
 * <p/>
 * The set of terminal positions is defined either in the constructor or with
 * subsequent calls to the {@link #markAsTerminalPosition(int, int)} method.
 * Terminal positions may also be removed with the
 * {@link #unmarkTerminalPosition(int, int)} and
 * {@link #unmarkAllTerminalPositions()} methods.
 * 
...
public class GridWorldTerminalFunction implements TerminalFunction {
	...
	/**
	 * Initializes with a terminal position at the specified agent x and y
	 * locaiton.
	 * 
	 * @param x
	 ...
	 * {@link IntPair} objects.
	 * 
	 * @param terminalPositions
	 *            the agent positions that are terminal states, specified with
	 *            {@link IntPair} objects.
	 */
	...
	/**
	 * Returns true if a position is marked as a terminal position; false
	 * otherwise.
	 * 
	 * @param x
	 *            the x location of the agent.
	 * @param y
	 *            the y location of the agent.
	 * @return true if a position is marked as a terminal position; false
	 *         otherwise.
	 */
