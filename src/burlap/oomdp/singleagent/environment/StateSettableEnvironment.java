 ...
 * {@link burlap.oomdp.singleagent.environment.Environment} instances that
 * allows the environment to have its set set to a client specified state.
 * 
...
public interface StateSettableEnvironment extends Environment {
	 ...
	 * 
	 * @param s
	 *            the state to which this
	 *            {@link burlap.oomdp.singleagent.environment.Environment} will
	 *            be set.
	 */
