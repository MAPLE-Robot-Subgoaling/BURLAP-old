...
/**
 * This abstract class is used to define shaped reward functions. Shaped reward
 * functions take the base true objective reward function of a task and add some
 * additional reward value to it that helps suggest useful states. Subclasses of
 * the ShapedRewardFunction must implement a method that specifies the additive
 * reward to the base reward.
 * 
 * 
...
public abstract class ShapedRewardFunction implements RewardFunction {
     ...
     *            the previous state
     * @param a
     *            the action taken the previous state
     * @param sprime
     *            the successor state
	...
	return this.baseRF.reward(s, a, sprime)
		+ this.additiveReward(s, a, sprime);
    }
