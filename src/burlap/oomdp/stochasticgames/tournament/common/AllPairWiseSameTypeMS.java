...
/**
 * This class defines a MatchSelctory that plays all pairwise matches of agents
 * in a round robin. It sets all agents to play as the same
 * {@link burlap.oomdp.stochasticgames.SGAgentType} and therefore is only valid
 * in symmetric games.
 * 
...
public class AllPairWiseSameTypeMS implements MatchSelector {
	 ...
	 * 
	 * @param at
	 *            the {@link burlap.oomdp.stochasticgames.SGAgentType} that all
	 *            agents will play as
	 * @param n
	 *            the number of agents in the tournament
	 */
