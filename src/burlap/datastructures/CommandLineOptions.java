...
/**
 * This class is used to extract command line options that are specified in the
 * form: "--option" or "--option=vaue". If an option does not have a value, its
 * associated value will be the empty string. If an option is not set, the
 * returned value is the empty string. Any command line arguments that are not
 * the specified form are not included in the option set.
 * 
...
public class CommandLineOptions {
    ...
    /**
     * Parses an array of command line arguments for the options and their
     * values
     * 
     * @param args
     *            the command line arguments passed to a main method.
     */
    ...
    /**
     * Returns whether the queried opton is set. This method will automatically
     * ignore a prefix "--" if it is included in the option name.
     * 
     * @param option
