...
public class UCTStateNode {
     ...
     */
    public UCTStateNode(StateHashTuple s, int d, List<Action> actions,
	    UCTActionConstructor constructor) {
	 ...
	 */
	public UCTStateNode generate(StateHashTuple s, int d,
