 ...
 * that satisfy a goal condition where the goal condition is specified by a
 * {@link burlap.behavior.singleagent.planning.StateConditionTest} object. No
 * other states are set as terminal states.
 * 
