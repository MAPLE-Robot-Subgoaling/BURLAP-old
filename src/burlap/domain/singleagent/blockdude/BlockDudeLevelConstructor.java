 ...
 * {@link burlap.domain.singleagent.blockdude.BlockDude} from levels in the
 * classic Block Dude game. Currently this class will provide the initial states
 * for the first three levels of Block Dude.
 * 
...
public class BlockDudeLevelConstructor {
	 ...
	 * 
	 * @param domain
	 *            the domain to which the state will belong.
	 * @return the initial {@link burlap.oomdp.core.states.State} of the first
	 *         level.
	 */
	...
	/**
	 * Returns the initial {@link burlap.oomdp.core.states.State} of the second
	 * level.
	 * 
	 * @param domain
	 *            the domain to which the state will belong.
	 * @return the initial {@link burlap.oomdp.core.states.State} of the second
	 *         level.
	 */
	...
	/**
	 * Returns the initial {@link burlap.oomdp.core.states.State} of the third
	 * level.
	 * 
	 * @param domain
	 *            the domain to which the state will belong.
	 * @return the initial {@link burlap.oomdp.core.states.State} of the third
	 *         level.
	 */
