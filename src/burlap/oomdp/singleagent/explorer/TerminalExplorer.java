 ...
 * specific states. States are conveyed to the user through a text description
 * in the terminal and the user specifies actions by typing the actions into the
 * terminal. Shorthand names for actions names may be provided. Action
 * parameters are specified by space delineated input. For instance:
 * "stack block0 block1" will cause the stack action to called with action
 * parameters block0 and block1. The command ##reset## causes the state to reset
 * to the initial state provided to the explorer.
 * 
...
public class TerminalExplorer {
    ...
    /**
     * Initializes the explorer with the specified domain and short hand names
     * for actions
     * 
     * @param domain
     *            the domain to explore
