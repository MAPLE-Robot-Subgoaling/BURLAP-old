 ...
 * One other advantage of this option is that it can be passed a valueFunction
 * from which its policy will be created. The valueFunction will be called from
 * each initiation state provided to the option constructor.
 * 
...
public class DeterministicTerminationOption extends Option {
	 ...
	 */
	public DeterministicTerminationOption(String name, Policy p,
	 ...
	 *            valueFunction
	 * @param planner
	 *            the valueFunction that is used to create the policy for this
	 *            option
	 * @param p
	 *            the valueFunction derived policy to use after planning from
	 *            each initial state is performed.
	 */
	public DeterministicTerminationOption(String name, StateConditionTest init,
			StateConditionTest terminationStates,
			List<State> seedStatesForPlanning, Planner planner,
			SolverDerivedPolicy p) {
