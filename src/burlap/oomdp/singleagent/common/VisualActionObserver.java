...
/**
 * This class enables the live rendering of action calls, updating the
 * visualizer to show the resulting state of an action call. Actions are stalled
 * for a specified interval of time to allow the state to be observed (by
 * default the value is set to 17ms, which is about 60FPS). This class is
 * especially useful for watching learning algorithms or Monte-Carlo-like
 * planning algorithms in action.
 * 
