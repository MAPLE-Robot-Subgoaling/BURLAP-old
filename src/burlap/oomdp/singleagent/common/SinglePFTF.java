 ...
 * exists a grounded version of a specified propositional function that is true
 * in the state or alternatively, when there is a grounded version that is false
 * in the state.
 * 
...
public class SinglePFTF implements TerminalFunction {
    ...
    /**
     * Initializes the propositional function that will cause the state to be
     * terminal when any Grounded version of pf is true.
     * 
     * @param pf
     *            the propositional function that must have a true grounded
     *            version for the state to be terminal.
     */
    ...
    /**
     * Initializes the propositional function that will cause the state to be
     * terminal when any Grounded version of pf is true or alternatively false.
     * 
     * @param pf
     *            the propositional function that must have a true grounded
     *            version for the state to be terminal.
     * @param terminateOnTrue
     *            when true requires a grounded version of pf to be true for the
     *            state to be terminal. When false requires a grounded version
     *            to be false to be terminal.
     */
     ...
     * grounded version of this classes propositional function or whether it is
