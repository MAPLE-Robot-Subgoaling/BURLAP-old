...
public class DiscreteStateHashFactory implements StateHashFactory {
    ...
    /**
     * Initializes this hashing factory to compute hash codes with all
     * attributes of all object classes.
     */
    ...
    /**
     * Sets this hashing factory to hash on only the attributes for the
     * specified classes in the provided map
     * 
     * @param attributesForHashCode
     *            a map from object class names to the attributes that should be
     *            used in the hash calculation for those object classes.
     */
    public void setAttributesForHashCode(
	    Map<String, List<Attribute>> attributesForHashCode) {
	this.attributesForHashCode = attributesForHashCode;
    }
     ...
     * If this method has not be called before and the class was initialized
     * with the default constructor, then only these class attributes, and those
     * specified by subsequent calls to this method or those specified by a
     * subsequent call of the other attribute setting methods will be used for
     * computing hash codes
     * 
     * @param classname
     *            the name of the class
     * @param atts
     *            the attributes whose values in object instances should be used
    ...
    /**
     * Specifies that an additional attribute of the specified class should be
     * used for computing hash codes. If this method has not be called before
     * and the class was initialized with the default constructor, then only
     * these class attributes, and those specified by subsequent calls to this
     * method or those specified by a subsequent call of the other attribute
     * setting methods will be used for computing hash codes
     * 
     * @param classname
     *            the name of the class
     * @param att
     *            the attribute whose values will be included in the computation
     *            of hash codes
     */
	...
	public void computeHashCode() {
		...
		// too ensure object order invariance, the hash values must
		// first be sorted by their object-wise hashcode
	...
	private int getIndexValue(ObjectInstance o, ObjectClass oc) {
		...
		if (att.type == AttributeType.DISC
		    ...
		    throw new RuntimeException(
			    "DiscreteStateHashFactory cannot compute hash for non discrete (discrete, boolean, or int) values");
		}
	...
	private List<Attribute> getAttributesForClass(ObjectClass oc) {
		...
		List<Attribute> selectedAtts = DiscreteStateHashFactory.this.attributesForHashCode
			.get(oc.name);
