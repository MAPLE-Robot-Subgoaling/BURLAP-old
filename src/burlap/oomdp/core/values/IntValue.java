...
public class IntValue extends Value {
	...
	throw new UnsupportedOperationException(
		"Value is Int, cannot add relational target");
    }

    @Override
    public void clearRelationTargets() {
	throw new UnsupportedOperationException(
		"Value is Int, cannot clear relational targets");
    }

    @Override
    public void removeRelationalTarget(String target) {
	throw new UnsupportedOperationException(
		"Value is Int, cannot remove relational target");
    }
	...
	throw new UnsupportedOperationException(
		"Value is Int, cannot return real value");
    }
	...
	throw new UnsupportedOperationException(
		"Value is Int, cannot return relational values");
    }
