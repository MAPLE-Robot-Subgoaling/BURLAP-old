...
/**
 * An agent factory for the {@link MultiAgentDPPlanningAgent} agent. Generated
 * agents are always provided a copy of the provided policy object to ensure
 * that multiple agents from the same factory use a policy specific to them.
 * 
...
public class MADPPlanAgentFactory implements AgentFactory {
	 ...
	 *            the domain for the agents
	 * @param planner
	 *            the valueFunction object that will be used by all generated
	 *            agents
	 * @param policy
	 *            the policy that will be copied and supplied to all generated
	 *            objects
	 */
	public MADPPlanAgentFactory(SGDomain domain, MADynamicProgramming planner,
	...
	public SGAgent generateAgent() {
		return new MultiAgentDPPlanningAgent(domain,
				this.plannerFactory.getPlannerInstance(), this.policy.copy());
	}
