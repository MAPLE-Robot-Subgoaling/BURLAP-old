...
/**
 * An action to int map that takes the list of possible action names in a domain
 * and assigns and int value to them. This method will not assign unique values
 * to actions with different parameters.
 * 
...
public class ParameterNaiveActionIdMap implements ActionIdMap {
    ...
    /**
     * Initializes a mapping from the names of all actions in a given domain to
     * an int value.
     * 
     * @param d
     *            the domain containing the actions.
     */
