 ...
 * in succession. The number of episodes used for planning can be determined by
 * a threshold maximum number of episodes, or by a maximum change in the
 * Q-function threshold.
 * 
 * <p/>
 ...
 * 
 */
public class QLearning extends OOMDPPlanner implements QComputablePlanner,
	LearningAgent {
     ...
     * a call to the {@link #planFromState(State)} method will cause the planner
     * to use only one episode for planning; this should probably be changed to
     * a much larger value if you plan on using this algorithm as a planning
     * algorithm.
     * 
     * @param domain
     *            the domain in which to learn
     ...
     * {@link burlap.behavior.singleagent.ValueFunctionInitialization} data
     * member.
     * 
     * @param s
