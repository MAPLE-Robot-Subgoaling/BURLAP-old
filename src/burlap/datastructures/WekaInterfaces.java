 ...
 * particular for turning sets of states into a Weka data set that can then be
 * used with Weka learning algorithms.
 * 
...
public class WekaInterfaces {
	 ...
	 * into a feature vector and then creating the Instance to hold that feature
	 * vector with the provided target supervised output value. The Weka
	 * {@link weka.core.Instance} is associated added to the provided
	 * {@link Instances} object. If it is null, then it makes one and adds it to
	 * that.
	 * 
	 * @param s
	 *            the state for which the instance is to be constructed
	 * @param fvgen
	 *            the
	 *            {@link burlap.behavior.singleagent.vfa.StateToFeatureVectorGenerator}
	 *            to turn the state into a feature vector.
	 * @param targetValue
	 *            the target supervised output value for the instance
	 * @param dataset
	 *            the dataset to which the created instance will be added.
	 * @return the created {@link weka.core.Instance}
	 */
	public static Instance getInstance(State s,
			StateToFeatureVectorGenerator fvgen, double targetValue,
			Instances dataset) {
	 ...
	 * 
	 * @param s
	 *            the input state from which the Weka dataset features will be
	 *            modeled.
	 * @param fvgen
	 *            The
	 *            {@link burlap.behavior.singleagent.vfa.StateToFeatureVectorGenerator}
	 *            that converts the state into a feature vector
	 * @param capacity
	 *            the reserved capacity for the dataset.
	 * @return the created {@link Instances} Weka dataset.
	 */
	public static Instances getInstancesShell(State s,
			StateToFeatureVectorGenerator fvgen, int capacity) {
