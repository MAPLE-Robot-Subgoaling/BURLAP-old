...
/**
 * This interface may be used by planning and learning algorithms that require
 * an initialization value for the Q-value function or the value function. A
 * common implementation for initializing all values to the same constant is
 * provided. This class extends the {@link ValueFunction} class, so the
 * initialization for the value function. may be retrieved with the standard
 * {@link ValueFunction#value(burlap.oomdp.core.states.State)} method. It also
 * adds a
 * {@link #qValue(burlap.oomdp.core.states.State, burlap.oomdp.core.AbstractGroundedAction)}
 * method for initializing Q-values.
 * 
...
public interface ValueFunctionInitialization extends ValueFunction {
	 ...
	 * 
	 */
	public class ConstantValueFunctionInitialization implements
		...
		/**
		 * Will cause this object to return <code>value</code> for all
		 * initialization values.
		 * 
		 * @param value
		 *            the value to return for all initializations.
		 */
