...
public interface ActionIdMap {
	...
	/**
	 * Returns an int value corresponding to the input action name and
	 * parameters
	 * 
	 * @param actionName
	 *            the input action name
	 * @param params
	 *            the input action parameters
	 * @return an int value corresponding to the input action name and
	 *         parameters
	 */
