 ...
 * be provided to any {@link Option} object to prevent the option from
 * performing the simulation. If the options path and number of steps cannot be
 * guaranteed in advance, then this interface should not be implemented.
 * 
