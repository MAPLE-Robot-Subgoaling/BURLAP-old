...
public class MultipleIntentionsMLIRLRequest extends MLIRLRequest {
	 ...
	 * {@link burlap.behavior.singleagent.learnfromdemo.mlirl.support.QGradientPlannerFactory.DifferentiableVIFactory}
	 * that is based on the provided
	 * {@link burlap.oomdp.statehashing.HashableStateFactory} object.
	 * 
	 * @param domain
	 *            the domain of the problem
	 * @param expertEpisodes
	...
	public MultipleIntentionsMLIRLRequest(Domain domain,
		...
		super(domain, null, expertEpisodes, rf);
		this.plannerFactory = new QGradientPlannerFactory.DifferentiableVIFactory(
	 ...
	 * Sets the
	 * {@link burlap.behavior.singleagent.learnfromdemo.mlirl.support.QGradientPlannerFactory}
	 * to use and also sets this request object's valueFunction instance to a
	 * valueFunction generated from it, if it has not already been set. Setting
	 * a valueFunction instance ensures that the {@link #isValid()} methods do
	 * not return false.
	 * 
	 * @param plannerFactory
	 *            the
