...
public class ActionFeaturesQuery {
	 ...
	 * 
	 * @param queryAction
	 *            the action with which state features will be associated
	 */
	 ...
	 * 
	 * @param queryAction
	 *            the action with which state features are associated
	 * @param features
	 *            the list of state features associated with this action.
	 */
	public ActionFeaturesQuery(GroundedAction queryAction,
	 ...
	 * 
	 * @param ga
	 *            a given action to check against
