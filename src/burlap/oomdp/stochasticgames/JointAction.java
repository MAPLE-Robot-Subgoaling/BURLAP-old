 ...
 * backed by a Map from agent names to the {@link GroundedSingleAction} taken by
 * that respective agent. The {@link GroundedSingleAction} objects of this class
...
public class JointAction implements Iterable<GroundedSingleAction> {
    ...
    /**
     * Initializes the internal data structure to keep a keep space for capacity
     * number of actions.
     * 
     * @param capacity
     */
    ...
    /**
     * Adds all {@link GroundedSingleAction} objects in a list to this joint
     * action.
     * 
     * @param actions
