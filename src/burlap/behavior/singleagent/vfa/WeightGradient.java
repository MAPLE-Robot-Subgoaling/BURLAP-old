...
/**
 * A data structure for defining the gradient of the weights for a vector. If
 * the weight gradient is not stored for a given feature, then zero will be
 * returned.
 * 
...
public class WeightGradient {
	...
	/**
	 * Initializes with the gradient unspecified, but reserves space for the
	 * given capacity
	 * 
	 * @param capacity
	 *            how much space to reserve for storing the gradient; i.e., the
	 *            number of weights over which the gradient will be defined
	 */
	 ...
	 * 
	 * @param weightId
	 * @return the partial derivative for the given weight; 0 if it is not
	 *         stored.
	 */
