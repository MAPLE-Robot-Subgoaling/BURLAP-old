 ...
 * {@link burlap.domain.singleagent.blockdude.BlockDude}. Returns true when the
 * agent is at an exit. If there are multiple exits, then returns true when the
 * agent is at any exit.
 * 
