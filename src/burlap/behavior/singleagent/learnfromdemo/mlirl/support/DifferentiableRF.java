...
public abstract class DifferentiableRF implements RewardFunction {
	 ...
	 * @param sp
	 *            the resulting state from the action
	...
	/**
	 * Returns the parameters of this reward function. The parameters are *not*
	 * copied, so changes made externally to them affect this reward function.
	 * 
