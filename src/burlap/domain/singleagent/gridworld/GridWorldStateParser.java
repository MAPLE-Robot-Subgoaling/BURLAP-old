...
public class GridWorldStateParser implements StateParser {
	...
	ObjectInstance a = s.getObjectsOfTrueClass(GridWorldDomain.CLASSAGENT)
		.get(0);
	List<ObjectInstance> locs = s
		.getObjectsOfTrueClass(GridWorldDomain.CLASSLOCATION);
	...
	for (ObjectInstance l : locs) {
	    sbuf.append(", ").append(l.getDiscValForAttribute(xa)).append(" ")
		    .append(l.getDiscValForAttribute(ya));
	}
