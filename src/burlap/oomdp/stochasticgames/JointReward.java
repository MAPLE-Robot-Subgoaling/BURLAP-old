...
/**
 * This interface defines the method needed to return the reward received by
 * each agent.
 * 
...
public interface JointReward {
     ...
     * The returned result is a Map from agent names to the reward that they
     * received.
     * 
     * @param s
     *            that state in which the joint action was taken.
     * @param ja
