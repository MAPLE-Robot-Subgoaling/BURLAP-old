 ...
 * 
 * A more robust policy would cause the planner to be called at each state to
 * build a new tree.
 * 
...
public class UCTTreeWalkPolicy extends Policy implements PlannerDerivedPolicy {
     ...
     * 
     * @param planner
     *            the UCT planner whose tree should be walked.
     */
     ...
     * 
     * @param snode
     *            the {@link UCTState} for which to get the best
     *            {@link UCTActionNode}.
