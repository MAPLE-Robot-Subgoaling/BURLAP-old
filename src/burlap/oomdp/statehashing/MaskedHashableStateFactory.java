 ...
 * in which the hash code and equality of the states ignores either
 * {@link burlap.oomdp.core.objects.ObjectInstance} belonging to specific
 * {@link burlap.oomdp.core.ObjectClass} or value assignments for specific
 * {@link burlap.oomdp.core.Attribute}s. You can specify which attributes and
 * object classes to ignore through an attribute name mask and an object class
 * name mask. There are a variety of methods for manipulating the masks. <br/>
 * <br/>
 * This class extends
...
public class MaskedHashableStateFactory extends SimpleHashableStateFactory {
	...
	/**
	 * Default constructor: object identifier independent, no hash code caching,
	 * and no object class or attribute masks.
	 */
	public MaskedHashableStateFactory() {
	}

	/**
	 * Initializes with no hash code caching and no object class or attribute
	 * masks.
	 * 
	 ...
	 */
	public MaskedHashableStateFactory(boolean identifierIndependent,
			boolean useCached, boolean maskNamesAreForAttributes,
			String... masks) {
		super(identifierIndependent, useCached);
	 ...
	 * 
	 * @param masks
	 *            the names of the {@link burlap.oomdp.core.Attribute}s to mask.
	 */
	 ...
	 * 
	 * @param masks
	 *            the names of the {@link burlap.oomdp.core.ObjectClass}s to
	 *            mask.
	 */
