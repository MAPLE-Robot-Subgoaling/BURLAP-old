...
public class TDLambda implements Critic {
    ...
    public TDLambda(RewardFunction rf, TerminalFunction tf, double gamma,
	    StateHashFactory hashingFactory, double learningRate, double vinit,
	    double lambda) {
	this.rf = rf;
	this.tf = tf;
	this.gamma = gamma;
     ...
     */
    public TDLambda(RewardFunction rf, TerminalFunction tf, double gamma,
	    StateHashFactory hashingFactory, double learningRate,
     ...
     * @return the {@link VValue} object (storing the value) for the given
     *         hashed stated.
     */
	 ...
	 */
	public StateEligibilityTrace(StateHashTuple sh, double eligibility,
		VValue v) {
	    this.sh = sh;
