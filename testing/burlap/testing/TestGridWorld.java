...
public class TestGridWorld {
	...
	public void testGridWorld(State s) {
		...
		List<GroundedAction> northActions = northAction
				.getAllApplicableGroundedActions(s);
		Assert.assertEquals(1, northActions.size());

		List<GroundedAction> eastActions = eastAction
				.getAllApplicableGroundedActions(s);
		Assert.assertEquals(1, eastActions.size());

		List<GroundedAction> southActions = southAction
				.getAllApplicableGroundedActions(s);
		Assert.assertEquals(1, southActions.size());

		List<GroundedAction> westActions = westAction
				.getAllApplicableGroundedActions(s);
