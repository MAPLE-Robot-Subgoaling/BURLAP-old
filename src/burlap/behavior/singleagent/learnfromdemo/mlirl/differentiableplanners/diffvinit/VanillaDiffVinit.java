...
/**
 * A class for the default condition when a value function initialization
 * returns an unparameterized value for each state, but must be differentiable
 * with respect to the reward function parameters for use with a differentiable
 * finite horizon valueFunction.
 * 
...
public class VanillaDiffVinit implements DifferentiableVInit {
	...
	/**
	 * The differentiable reward function that defines the parameter space over
	 * which this value function initialization must differentiate.
	 */
	 ...
	 * 
	 * @param vinit
	 *            The vanilla unparameterized value function initialization
	 * @param rf
	 *            the differentiable reward function that defines the total
	 *            parameter space
	 */
