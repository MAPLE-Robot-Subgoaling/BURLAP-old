 ...
 * to YAML strings (and back from them) for any possible input domain. Use of
...
public class StateYAMLParser implements StateParser {
	 ...
	 * in yaml strings will be converted to. This is not necessary if parsing
	 * will only go from states to strings and not strings to states.
	 */
	protected Domain domain;

	/**
	 * Initializes with a a given domain object. The domain object is used for
	 ...
	 * 
	 * @param s
	 *            the input state to turn into a YAML prepared datastructure
