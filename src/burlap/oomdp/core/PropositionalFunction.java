...
public abstract class PropositionalFunction {
    ...
    protected String[] parameterClasses; // list of class names for each
					 // parameter of the function
    protected String[] parameterOrderGroup; // setting two or more parameters to
					    // the same order group indicates
					    // that the function evaluate the
					    // same regardless of which specific
					    // object is set to each parameter
    protected String pfClass; // optional; allows propositional functions to be
     ...
     * with the given parameters params is expected to be comma delimited with
