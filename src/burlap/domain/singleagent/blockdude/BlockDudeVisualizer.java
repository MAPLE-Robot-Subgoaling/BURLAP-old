 ...
 * The agent is a blue square with a gold eye indicating the direction it's
 * facing; bricks are rendered in green; the exit in black, and movable blocks
 * in grey.
 * 
...
public class BlockDudeVisualizer {
	 ...
	 * indicating the direction its facing.
	 */
